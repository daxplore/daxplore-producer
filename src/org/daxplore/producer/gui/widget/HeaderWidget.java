...
public class HeaderWidget extends JPanel implements AbstractWidgetEditor<MetaGroup> {
	
	private JLabel textField;
	private JLabel idField;
	private MetaGroup metaGroup;
	private Locale locale;
	private String htmlFormat = "<html><b style=\"font-size:10px\">{0}</b></html>";
	private String missingFormat = "<html><i style=\"font-size:10px\">missing header text</i></h2></html>";
	private String idFormat = "<html>(<b>{0}</b>)</html>";
	
	public HeaderWidget(final EventBus eventBus) {
