...
public class NaiveBayesClassifier {
	...
	public static LinkedList<String> getStats(String q, String s, Integer alt){
		LinkedList<String> linkedlist = new LinkedList<String>();
		StringBuilder req = new StringBuilder("");
		req.append("q=" + q);
		req.append("&sel=" + s);
		req.append("&alt=" + new Integer(alt +1 ).toString());
