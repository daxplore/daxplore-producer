...
/**
 * Open panel view, displays the open and create daxplore file function as well
 * as the import SPSS file wizard button and information panel. If a file is
 * loaded, the panels will show file information.
 * 
 * @author hkfs89
 * 
 */
public class OpenPanelView extends JPanel {
	...
	public OpenPanelView(final GuiMain guiMain) {
		...
		guiFilePanel.setBorder(new TitledBorder(null,
				"Daxplore file information", TitledBorder.LEADING,
				TitledBorder.TOP, null, null));

		JPanel importSPSSPanel = new JPanel();
		importSPSSPanel.setBorder(new TitledBorder(null, "Import SPSS File",
				TitledBorder.LEADING, TitledBorder.TOP, null, null));

		GroupLayout gl_openPanel = new GroupLayout(this);

		gl_openPanel
				.setHorizontalGroup(gl_openPanel
										...
										.addGroup(
												gl_openPanel
														...
														.addComponent(
																...
																Short.MAX_VALUE))
										.addContainerGap()));
		gl_openPanel.setVerticalGroup(gl_openPanel.createParallelGroup(
				Alignment.LEADING).addGroup(
				gl_openPanel
						.createSequentialGroup()
						.addContainerGap()
						.addComponent(guiFilePanel, GroupLayout.PREFERRED_SIZE,
								379, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(importSPSSPanel,
		...
		importWizardButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ImportWizardDialog importWizardDialog = new ImportWizardDialog(
						guiMain);

				ImportWizardDescriptor openFilePanelDescriptor = new OpenFilePanelDescriptor();
				importWizardDialog.registerWizardPanel(
						OpenFilePanelDescriptor.IDENTIFIER,
						openFilePanelDescriptor);

				ImportWizardDescriptor charsetPanelDescriptor = new CharsetPanelDescriptor();
				importWizardDialog.registerWizardPanel(
						CharsetPanelDescriptor.IDENTIFIER,
						charsetPanelDescriptor);

				ImportWizardDescriptor finalImportPanelDescriptor = new FinalImportPanelDescriptor();
				importWizardDialog.registerWizardPanel(
						FinalImportPanelDescriptor.IDENTIFIER,
						finalImportPanelDescriptor);

				importWizardDialog
						.setCurrentPanel(OpenFilePanelDescriptor.IDENTIFIER);
		...
		createNewFileButton
				.setToolTipText("Creates a new daxplore project file");
